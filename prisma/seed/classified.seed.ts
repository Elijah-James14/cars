...
export async function SeedClassfieds(prisma: PrismaClient) {
  ...
  for (let i = 0; i < 25; i++) {
    ...
    classifiedsData.push({
      ...
      petrol: faker.helpers.arrayElement(Object.values(FuelType)),
  ...
  console.log(`Classifieds seeded total of ${result.count} classifieds seeded`);
}
